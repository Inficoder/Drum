...
public class SendMail {
    ...
    public static String myEmailAccount = "767174855@qq.com";
    public static String myEmailPassword = "mpkjpgzmhjfubgah";
    // 发件人邮箱的 SMTP 服务器地址, 必须准确, 不同邮件服务器地址不同, 一般(只是一般, 绝非绝对)格式为: smtp.xxx.com
    // 网易126邮箱的 SMTP 服务器地址为: smtp.126.com
    public static String myEmailSMTPHost = "smtp.qq.com";

    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "tianhaonan@buaa.edu.cn";
...
//        EHLO win-2019110501
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        // 4. Subject: 邮件主题
        message.setSubject("asds主题", "UTF-8");

        // 5. Content: 邮件正文（可以使用html标签）
        message.setContent("邮件正文qweqwe", "text/html;charset=UTF-8");
        // 6. 设置发件时间
